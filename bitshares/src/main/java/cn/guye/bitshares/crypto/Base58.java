...
public class Base58 {
     ...
     * @throws MalformedAddressException if the given string is not a valid base58 string
     */
    public static byte[] decode(String input) throws MalformedAddressException {
        if (input.length() == 0) {
            return new byte[0];
        }
        ...
        for (int i = 0; i < input.length(); ++i) {
            ...
            if (digit < 0) {
                throw new MalformedAddressException("Illegal character " + c + " at position " + i);
            }
    ...
    public static BigInteger decodeToBigInteger(String input) throws MalformedAddressException {
