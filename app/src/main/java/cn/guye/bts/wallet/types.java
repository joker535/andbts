...
import static cn.guye.bts.wallet.config.GRAPHENE_ADDRESS_PREFIX;
...
public class types {
    ...
    public static class public_key_type {
        ...
        public public_key_type(String strBase58) throws NoSuchAlgorithmException {
            ...
            byte[] byteKeyData = new byte[0];
            try {
                byteKeyData = Base58.decode(strBase58.substring(strPrefix.length()));
