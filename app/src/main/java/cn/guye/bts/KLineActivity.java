...
import cn.guye.bts.bean.DataParse;
import cn.guye.bts.bean.KLineBean;
import cn.guye.bts.bean.KMAEntity;
import cn.guye.bts.bean.VMAEntity;
import cn.guye.bts.common.ConstantTest;
import cn.guye.bts.contorl.BtsContorler;
import cn.guye.bts.contorl.BtsRequest;
import cn.guye.bts.contorl.BtsRequestHelper;
import cn.guye.bts.mychart.CoupleChartGestureListener;
import cn.guye.bts.mychart.MyBottomMarkerView;
import cn.guye.bts.mychart.MyCombinedChart;
import cn.guye.bts.mychart.MyHMarkerView;
import cn.guye.bts.mychart.MyLeftMarkerView;
import cn.guye.bts.utils.MyUtils;
import cn.guye.bts.utils.VolFormatter;
...
//    private DataParse mCacheData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BtsRequest r = BtsRequestHelper.get_market_history("1.3.113", quoteId, 24 * 60 * 60, start, new Date(), new BtsRequest.CallBack() {
            @Override
            public void onResult(BtsRequest request, JsonElement data) {
                ...
                mData = new DataParse();
                mData.parseKLine(quoteId,bucketObjects);
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        initCharData(); setKLineByChart(mChartKline);
